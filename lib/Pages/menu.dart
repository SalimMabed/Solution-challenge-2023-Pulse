        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              padding: EdgeInsets.fromLTRB(26*fem, 13*fem, 25*fem, 13*fem),
              width: double.infinity,
              decoration: BoxDecoration (
            ...
            Container(
              ...
              padding: EdgeInsets.fromLTRB(2*fem, 43*fem, 2*fem, 59*fem),
              width: double.infinity,
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                  ...
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 141*fem, 28*fem),
                    child: Text(
                      'Report issues',
                      style: SafeGoogleFont (
                        'Roboto',
                  ...
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(38*fem, 0*fem, 35*fem, 42.71*fem),
                    width: double.infinity,
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
...
GestureDetector(
  ...
  child: Container(
    ...
    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 21*fem, 0.65*fem),
    width: 60*fem,
    height: 59.64*fem,
    child: Image.asset(
...
GestureDetector(
  onTap: () {
    String fbUrl = 'https://www.instagram.com/your-instagram-page-url';
    launch(fbUrl);
  },
  child: Container(
    // iconfacebookqMF (127:14)
     margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 32*fem, 0.29*fem),
...
GestureDetector(
  onTap: () {
    String fbUrl = 'https://www.twitter.com/your-twitter-page-url';
    launch(fbUrl);
  },
  child: Container(
    // iconfacebookqMF (127:14)
    margin: EdgeInsets.fromLTRB(0*fem, 0.48*fem, 20*fem, 0*fem),
    width: 60*fem,
    height: 48.77*fem,
    child: Image.asset(
...
GestureDetector(
  onTap: () {
    String fbUrl = 'https://www.whatsapp.com/your-whatsapp-page-url';
    launch(fbUrl);
  },
  child: Container(
    // iconfacebookqMF (127:14)
